      ...
      <div className="post">
        <div className="post-header">
          <div className="profile-img">
            <img className="my-img" src={img} width={70} height={70} alt="Profile-img" />
          </div>
        ...
        <div className="post-footer">
          <div className="button"> <HandThumbsUp />Like
          </div>
          <div className="button"><ChatLeftText /> Comment
          </div>
          <div className="button"><ShareFill /> Share
          </div>
        </div>
      </div>
    </div>
